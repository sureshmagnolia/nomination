      ...
      ${isDraft ? `
        ...
        <div class="glass rounded-xl p-4 border border-amber-500/30 bg-amber-500/10 flex items-start gap-3 text-amber-200 text-sm shadow-lg">
          ...
          <div>
            ...
            Serial numbers shown as <strong>D1, D2, D3...</strong> are provisional and subject to change upon finalization. Any corrections or changes may be intimated to the Returning Officer (RO) in written form duly forwarded by the HoD of the department, before <strong>${esc(formatCorrectionDeadline(settings.draftRollEnd))}</strong>.
          </div>
        </div>
      ` : ''}
