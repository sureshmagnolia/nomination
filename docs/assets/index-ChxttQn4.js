var e=Object.defineProperty,t=(t,n)=>{let r={};for(var i in t)e(r,i,{get:t[i],enumerable:!0});return n||e(r,Symbol.toStringTag,{value:`Module`}),r};(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var n={APPS_SCRIPT_URL:`https://script.google.com/macros/s/AKfycbw29XuhvNI4cV-tlAWz5IaRrWPY1T9P7ZiQJbu-7za9226PyEqlhuLOrOMTG2QulzzOog/exec`,ELECTION_DATE:`2026-10-12`,COLLEGE_NAME:`Government Victoria College, Palakkad`,DEFAULT_POSTS:[{post:`The Chairman`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!1},{post:`The Vice Chairman`,femaleOnly:!0,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!1},{post:`The Secretary`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!1},{post:`The Joint Secretary`,femaleOnly:!0,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!1},{post:`The Chief Student Editor`,femaleOnly:!1,finalYearIneligible:!0,yearRestriction:``,deptRestriction:!1},{post:`The Secretary Fine Arts`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!1},{post:`The General Captain For Sports And Games`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!1},{post:`The University Union Councillor`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!1},{post:`I UG Representative`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:`1`,deptRestriction:!1},{post:`II UG Representative`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:`2`,deptRestriction:!1},{post:`III UG Representative`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:`3`,deptRestriction:!1},{post:`PG Representative`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:`PG`,deptRestriction:!1},{post:`Association Secretary Botany`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Chemistry`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Commerce`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Computer Science`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Economics`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary English`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Hindi`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary History`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Malayalam`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Mathematics`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Physics`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Psychology`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Sanskrit`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Tamil`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0},{post:`Association Secretary Zoology`,femaleOnly:!1,finalYearIneligible:!1,yearRestriction:``,deptRestriction:!0}]},r=t({router:()=>o}),i={},a=`/`,o={on(e,t){return i[e]=t,this},setDefault(e){return a=e,this},navigate(e,t={}){window.history.pushState({path:e,params:t},``,`#${e}`),this._resolve(e,t)},start(){window.addEventListener(`popstate`,e=>{let{path:t,params:n}=e.state||{path:a,params:{}};this._resolve(t,n)});let e=window.location.hash.replace(`#`,``)||a;this._resolve(e,{})},_resolve(e,t){let n=i[e]||i[a];n&&n(t)}},s=n.APPS_SCRIPT_URL;async function c(e){let t=new URL(s);Object.entries(e).forEach(([e,n])=>t.searchParams.append(e,n)),t.searchParams.append(`_t`,Date.now());let n=await fetch(t.toString());if(!n.ok)throw Error(`Network error: ${n.status}`);let r=await n.json();if(r.error)throw Error(r.error);return r}async function l(e){let t=await fetch(s,{method:`POST`,headers:{"Content-Type":`text/plain;charset=utf-8`},body:JSON.stringify(e)});if(!t.ok)throw Error(`Network error: ${t.status}`);let n=await t.json();if(n.error)throw Error(n.error);return n}var u={getNominalRoll:()=>c({action:`getNominalRoll`}),getPosts:()=>c({action:`getPosts`}),getPublicNominations:()=>c({action:`getPublicNominations`}),getNomination:e=>c({action:`getNomination`,id:e}),getValidNominations:()=>c({action:`getValidNominations`}),getFinalNominations:()=>c({action:`getFinalNominations`}),submitNomination:e=>l({action:`submitNomination`,...e}),submitWithdrawal:e=>l({action:`submitWithdrawal`,id:e}),adminLogin:e=>l({action:`adminLogin`,password:e}),adminSendOTP:e=>l({action:`adminSendOTP`,password:e}),adminVerifyOTP:(e,t)=>l({action:`adminVerifyOTP`,password:e,otp:t}),adminGetNominations:e=>c({action:`adminGetNominations`,password:e}),adminVerifyNomination:(e,t,n)=>l({action:`adminVerifyNomination`,password:e,id:t,status:n}),adminApproveWithdrawal:(e,t)=>l({action:`adminApproveWithdrawal`,password:e,id:t}),adminPublishValidList:e=>l({action:`adminPublishValidList`,password:e}),adminPublishFinalList:e=>l({action:`adminPublishFinalList`,password:e}),adminGetSettings:e=>c({action:`adminGetSettings`,password:e}),adminUpdateSettings:(e,t)=>l({action:`adminUpdateSettings`,password:e,...t}),getPublicSettings:()=>c({action:`adminGetSettings`,password:`NONE`}),adminGetPosts:e=>c({action:`adminGetPosts`,password:e}),adminAddPost:(e,t)=>l({action:`adminAddPost`,password:e,...t}),adminUpdatePost:(e,t)=>l({action:`adminUpdatePost`,password:e,...t}),adminDeletePost:(e,t)=>l({action:`adminDeletePost`,password:e,postName:t}),adminReorderPosts:(e,t)=>l({action:`adminReorderPosts`,password:e,posts:t}),adminGetBooths:e=>c({action:`adminGetBooths`,password:e}),adminSaveBooths:(e,t)=>l({action:`adminSaveBooths`,password:e,booths:t}),adminGetLocations:e=>c({action:`adminGetLocations`,password:e}),adminSaveLocations:(e,t)=>l({action:`adminSaveLocations`,password:e,locations:t}),getResults:()=>c({action:`getResults`}),adminSaveResults:(e,t)=>l({action:`adminSaveResults`,password:e,results:t}),adminInjectTestData:e=>l({action:`adminInjectTestData`,password:e}),adminWipeData:e=>l({action:`adminWipeData`,password:e}),adminGetCountingMatrix:e=>c({action:`adminGetCountingMatrix`,password:e}),adminSaveCountingMatrix:(e,t)=>l({action:`adminSaveCountingMatrix`,password:e,matrixData:t}),getSettings:()=>c({action:`getSettings`}),adminAddStudent:(e,t)=>l({action:`adminAddStudent`,password:e,...t}),adminDeleteStudent:(e,t)=>l({action:`adminDeleteStudent`,password:e,serial:t}),adminFinalizeRoll:e=>l({action:`adminFinalizeRoll`,password:e}),_scheduleCache:null,getPublicSchedule:async function(){if(this._scheduleCache)return this._scheduleCache;let e=await c({action:`getPublicSchedule`});return this._scheduleCache=e,e},adminSaveSchedule:async function(e,t){let n=await l({action:`adminSaveSchedule`,password:e,...t});return this._scheduleCache=null,n}};function d(e,t=n.ELECTION_DATE){if(!e)return`N/A`;let r=new Date(t),i=new Date(e),a=r.getFullYear()-i.getFullYear(),o=r.getMonth()-i.getMonth(),s=r.getDate()-i.getDate();return s<0&&(o--,s+=new Date(r.getFullYear(),r.getMonth(),0).getDate()),o<0&&(a--,o+=12),`${a} Years, ${o} Months, ${s} Days`}function f(e,t,n,r=null,i=[],a=[]){if(!e)return[];let o=[],s=String(e.CLASS||``).toUpperCase(),c=String(e.Dept||``).toUpperCase(),l=String(e[`Nominal Roll Serial Number`]),u=i.find(e=>e.post===t)||{};if((n===`Proposer`||n===`Seconder`)&&a.some(e=>e.post===t&&e.status!==`Rejected`&&(String(e.proposerSerial)===l||String(e.seconderSerial)===l))&&o.push(`Student #${l} has already proposed or seconded a candidate for "${t}". They cannot endorse multiple candidates for the same post.`),u.deptRestriction){let r=`Association Secretary `,i=t.startsWith(r)?t.replace(r,``).toUpperCase():null;i&&c!==i&&o.push(`${n} for "${t}" must be from the ${i} dept (current: ${e.Dept||`N/A`}).`)}let d=String(u.yearRestriction||``);return d===`1`&&!s.includes(`1ST YEAR`)&&o.push(`${n} must be a 1st Year student for this post.`),d===`2`&&!s.includes(`2ND YEAR`)&&o.push(`${n} must be a 2nd Year student for this post.`),d===`3`&&!s.includes(`3RD YEAR`)&&o.push(`${n} must be a 3rd Year student for this post.`),d===`PG`&&(s.includes(`MA`)||s.includes(`MSC`)||s.includes(`MCOM`)||s.includes(`M.SC`)||s.includes(`M.COM`)||s.includes(`M.A`)||o.push(`${n} for PG Representative must be a PG student (MA/MSc/MCom).`)),n===`Candidate`&&r&&(u.femaleOnly&&r===`Male`&&o.push(`The post of "${t}" is reserved for female candidates only.`),u.finalYearIneligible&&(s.includes(`3RD YEAR`)||s.includes(`2ND YEAR M`))&&o.push(`Final year students are not eligible for "${t}".`)),o}function p(){let e=Math.floor(Math.random()*10)+1,t=Math.floor(Math.random()*10)+1;return{question:`${e} + ${t}`,answer:String(e+t)}}function m(){return new Date().toLocaleDateString(`en-GB`)}function h(e,t,n){let r=[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`];for(let t=1;t<=31;t++)e.innerHTML+=`<option value="${t}">${t}</option>`;r.forEach((e,n)=>t.innerHTML+=`<option value="${n+1}">${e}</option>`);for(let e=2015;e>=1950;e--)n.innerHTML+=`<option value="${e}">${e}</option>`}function g(e,t,n){return`${n}-${String(t).padStart(2,`0`)}-${String(e).padStart(2,`0`)}`}function _(e,t,n){return`${String(e).padStart(2,`0`)}/${String(t).padStart(2,`0`)}/${n}`}function v(e,t=`Nomination Form`){let n=window.open(``,`_blank`);n.document.write(`
  ...
  `),n.document.close()}function y(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function b(e,t,n){t?(e.disabled=!0,e.innerHTML=`<span class="spinner"></span> Please wait...`):(e.disabled=!1,e.innerHTML=n)}function x(e,t=`info`){let n={info:`#6366f1`,success:`#10b981`,error:`#ef4444`,warning:`#f59e0b`},r=document.createElement(`div`);r.style.cssText=`position:fixed;bottom:1.5rem;right:1.5rem;z-index:9999;padding:0.75rem 1.25rem;border-radius:0.5rem;color:white;font-size:0.875rem;font-weight:500;background:${n[t]||n.info};box-shadow:0 10px 40px rgba(0,0,0,0.4);max-width:320px;transition:opacity 0.4s;`,r.textContent=e,document.body.appendChild(r),setTimeout(()=>{r.style.opacity=`0`,setTimeout(()=>r.remove(),400)},3500)}async function S(e){e.innerHTML=`<div class="min-h-screen flex items-center justify-center"><span class="spinner"></span></div>`;let t=new Date().getFullYear(),n=`Government Victoria College, Palakkad`,r=`GVC`;try{let[e,i]=await Promise.all([u.getPublicSchedule(),u.getPublicSettings().catch(()=>({}))]);e.electionYear&&(t=e.electionYear),i.collegeName&&(n=i.collegeName),i.collegeShortName&&(r=i.collegeShortName)}catch{}e.innerHTML=`
      ...
      <header class="glass sticky top-0 z-50 border-b border-white/10">
        <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            <h1 class="text-xl font-bold text-white tracking-tight">${y(r)} Election Portal ${t}</h1>
          </div>
      ...
      <main class="flex-1 max-w-6xl mx-auto px-6 py-12 w-full">
        <div class="text-center mb-16 space-y-4">
          ...
          <p class="text-slate-400 text-lg max-w-2xl mx-auto">
            Welcome to the official election portal of ${y(n)}. 
            Submit your nominations, track status, and view the finalized candidate lists for the year ${t}.
          </p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ${C(`/submit`,`📝`,`Submit Nomination`,`New nomination form with eligibility check.`)}
          ${C(`/find`,`🔍`,`Find My Nomination`,`Retrieve and print your submitted nomination.`)}
          ${C(`/withdraw`,`↩️`,`Withdraw Nomination`,`Request withdrawal of your candidacy.`)}
          ${C(`/valid-list`,`✅`,`Valid Nominations`,`View the list of verified candidates.`)}
          ${C(`/nominal-roll`,`📜`,`Nominal Roll`,`View the official voter list (Draft/Final).`)}
          ${C(`/final-list`,`🏆`,`Final Candidate List`,`View the final list post-withdrawals.`)}
          ${C(`/results`,`📊`,`Live Results`,`View live vote counting and election results.`)}
        </div>
      </main>

      <footer class="py-12 border-t border-white/5 text-center text-slate-500 text-sm">
        <p>&copy; ${t} ${y(n)}</p>
        <p class="mt-1 font-medium text-slate-400">Developed by Exam Wing ${y(r)}</p>
      </footer>
    </div>
  ...
  <div data-nav="${e}" class="glass p-6 rounded-2xl hover:bg-white/5 transition group cursor-pointer border border-white/5 hover:border-indigo-500/30">
    ...
    <h3 class="text-lg font-bold text-white mb-2 group-hover:text-indigo-300 transition">${y(n)}</h3>
    <p class="text-sm text-slate-400 leading-relaxed">${y(r)}</p>
  ...
  </div>`}var w=[],T=[],E=[],D={},O=``;async function k(e){let t=new Date().getFullYear();try{let e=await u.getPublicSchedule();e.electionYear&&(t=e.electionYear)}catch{}e.innerHTML=re(`Submit Nomination`,`
  ...
  `,t),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`));try{let[r,i,a,o]=await Promise.all([u.getNominalRoll(),u.getPosts().catch(()=>null),u.getPublicNominations().catch(()=>[]),u.getPublicSchedule().catch(()=>({}))]);if(w=Array.isArray(r)?r:[],E=Array.isArray(a)?a:[],D=o||{},w.length===0)throw Error(`Nominal roll is empty. Please contact the admin.`);T=Array.isArray(i)&&i.length>0?i:n.DEFAULT_POSTS,ee(e,t)}catch(t){e.querySelector(`#loadingState`).innerHTML=`
      <div class="alert alert-error">${y(t.message)}</div>
      <button class="btn btn-secondary mt-4" id="backBtn">← Back to Home</button>`,e.querySelector(`#backBtn`).addEventListener(`click`,()=>o.navigate(`/`))}}function ee(e,t){let n=p();O=n.answer,e.querySelector(`#loadingState`).classList.add(`hidden`);let r=e.querySelector(`#formArea`);r.classList.remove(`hidden`);let i=new Date,a=D.nominationDeadline?new Date(D.nominationDeadline):null;if(!window.ADMIN_BYPASS_PWD&&a&&i>a){r.innerHTML=`
    ...
    <form id="nomForm" class="space-y-8">
      ...
      <div>
        ...
        <select id="postSelect" class="field">${T.map(e=>`<option value="${y(e.post)}">${y(e.post)}</option>`).join(``)}</select>
      </div>

      <!-- Three columns: Candidate / Proposer / Seconder -->
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ${A(`candidate`,`Candidate`,!0)}
        ${A(`proposer`,`Proposer`,!1)}
        ${A(`seconder`,`Seconder`,!1)}
      </div>
  ...
  `,h(r.querySelector(`#dob-day`),r.querySelector(`#dob-month`),r.querySelector(`#dob-year`)),[`candidate`,`proposer`,`seconder`].forEach(e=>{r.querySelector(`#serial-${e}`).addEventListener(`change`,()=>te(r,e))}),r.querySelector(`#postSelect`).addEventListener(`change`,()=>j(r)),r.querySelectorAll(`[name="gender"]`).forEach(e=>e.addEventListener(`change`,()=>j(r))),r.querySelectorAll(`.dob-sel`).forEach(e=>e.addEventListener(`change`,()=>j(r))),r.querySelector(`#refreshCaptcha`).addEventListener(`click`,()=>{let e=p();O=e.answer,r.querySelector(`#captchaInput`).value=``,r.querySelector(`#captchaQuestion`).textContent=e.question}),r.querySelector(`#backHomeBtn`).addEventListener(`click`,()=>o.navigate(`/`)),r.querySelector(`#nomForm`).addEventListener(`submit`,e=>ne(e,r,t))}function A(e,t,n){return`
  ...
  </div>`}function te(e,t){let n=e.querySelector(`#serial-${t}`).value.trim(),r=e.querySelector(`#details-${t}`),i=w.find(e=>String(e[`Nominal Roll Serial Number`])===n);if(!i){r.innerHTML=n?`<span class="text-red-400">⚠ Student not found</span>`:``;return}r.innerHTML=`
    <p><span class="text-slate-500">Name:</span> <strong class="text-slate-200">${y(i.NAME)}</strong></p>
    <p><span class="text-slate-500">Class:</span> ${y(i.CLASS)}</p>
    <p><span class="text-slate-500">Dept:</span> ${y(i.Dept||`N/A`)}</p>`,j(e)}function j(e){let t=[],n=e.querySelector(`#postSelect`).value,r=e.querySelector(`[name="gender"]:checked`)?.value||null,i=[`candidate`,`proposer`,`seconder`].map(t=>e.querySelector(`#serial-${t}`).value.trim()),a=i.map(e=>e?w.find(t=>String(t[`Nominal Roll Serial Number`])===e):null),[o,s,c]=i;o&&o===s&&t.push(`Candidate and Proposer cannot be the same person.`),o&&o===c&&t.push(`Candidate and Seconder cannot be the same person.`),s&&s===c&&t.push(`Proposer and Seconder cannot be the same person.`);let l=[`Candidate`,`Proposer`,`Seconder`];a.forEach((e,i)=>{e&&t.push(...f(e,n,l[i],i===0?r:null,T,E))});let u=e.querySelector(`#warningBox`);return t.length?(u.innerHTML=`<strong class="block mb-1">⚠ Eligibility Warnings</strong>`+t.map(e=>`<p class="text-sm">• ${y(e)}</p>`).join(``),u.classList.remove(`hidden`)):u.classList.add(`hidden`),t}async function ne(e,t,n){if(e.preventDefault(),j(t).length){x(`Please resolve all eligibility warnings first.`,`error`);return}if(t.querySelector(`#captchaInput`).value.trim()!==O){x(`Captcha answer is incorrect.`,`error`);return}let r=t.querySelector(`#postSelect`).value,i=t.querySelector(`[name="gender"]:checked`)?.value,a=t.querySelector(`#dob-day`).value,o=t.querySelector(`#dob-month`).value,s=t.querySelector(`#dob-year`).value;if(!i){x(`Please select a gender for the candidate.`,`error`);return}if(!a||!o||!s){x(`Please enter a complete date of birth.`,`error`);return}let c=[`candidate`,`proposer`,`seconder`].map(e=>t.querySelector(`#serial-${e}`).value.trim()),l=c.map(e=>w.find(t=>String(t[`Nominal Roll Serial Number`])===e));if(l.some(e=>!e)){x(`One or more serial numbers are invalid.`,`error`);return}let d=t.querySelector(`#submitBtn`);b(d,!0,`Generate &amp; Preview Nomination`);try{let e={post:r,gender:i,dob:g(a,o,s),candidateSerial:c[0],proposerSerial:c[1],seconderSerial:c[2]};window.ADMIN_BYPASS_PWD&&(e.password=window.ADMIN_BYPASS_PWD);let d=await u.submitNomination(e);M(t,d.id,{post:r,gender:i,day:a,month:o,year:s,students:l},n),x(`Nomination submitted! ID: ${d.id}`,`success`)}catch(e){x(`Submission failed: ${e.message}`,`error`)}finally{b(d,!1,`Generate &amp; Preview Nomination`)}}function M(e,t,{post:n,gender:r,day:i,month:a,year:o,students:s},c){let[l,u,f]=s,p=g(i,a,o),m=_(i,a,o),h=d(p),y=e.querySelector(`#previewSection`);e.querySelector(`#printZone`).innerHTML=N(t,n,r,m,h,l,u,f,``,c),y.classList.remove(`hidden`),y.scrollIntoView({behavior:`smooth`}),y.querySelector(`#printBtn`).addEventListener(`click`,()=>{v(e.querySelector(`#printZone`).innerHTML)}),y.querySelector(`#newNomBtn`).addEventListener(`click`,()=>k(e.closest(`#app`)))}function N(e,t,r,i,a,o,s,c,l=``,u=`2026`){let d=m();return`
  <div class="print-paper border border-slate-700 rounded-xl p-8 bg-slate-900 text-slate-200 space-y-4">
    <div class="flex justify-between items-start text-sm">
      ...
      <div class="text-right">
        ...
        ${l?`<span class="badge badge-${l.toLowerCase()}">${y(l)}</span>`:``}
      </div>
    </div>
    <h2 class="text-center font-bold text-xl text-white border-y border-white/10 py-3">NOMINATION PAPER</h2>
    <p class="text-sm"><span class="font-semibold text-slate-400 w-40 inline-block">Post Applied For:</span> <strong class="text-white">${y(t)}</strong></p>
    <div class="space-y-3">
      ${P(`Candidate`,o,r,i,a)}
      ${P(`Proposer`,s)}
      ${P(`Seconder`,c)}
    ...
    <div class="border-t border-white/10 pt-2 text-right">
      <p class="text-[10px] text-slate-500 font-mono">Ref ID: ${y(e)}</p>
    </div>
  ...
  <div class="glass rounded-lg p-4 text-sm space-y-1">
    ...
    <div class="grid grid-cols-2 gap-x-4 gap-y-1">
      <p><span class="text-slate-500">Name:</span> <strong class="text-slate-200">${y(t.NAME)}</strong></p>
      <p><span class="text-slate-500">Class:</span> ${y(t.CLASS)}</p>
      <p><span class="text-slate-500">Dept:</span> ${y(t.Dept||`N/A`)}</p>
      <p><span class="text-slate-500">Electoral Roll No:</span> ${y(t[`Nominal Roll Serial Number`])}</p>
      ${n?`<p><span class="text-slate-500">Gender:</span> ${y(n)}</p>`:``}
      ${r?`<p><span class="text-slate-500">Date of Birth:</span> ${y(r)}</p>`:``}
      ${i?`<p class="col-span-2"><span class="text-slate-500">Age as on Notification Date:</span> ${y(i)}</p>`:``}
    </div>
    ${e===`Candidate`?``:`
  ...
  </div>`:``}function re(e,t,n=`2026`){return`
    ...
    <header class="no-print sticky top-0 z-50 border-b border-white/10 glass">
      <div class="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
        <div class="flex items-center gap-4">
          ...
          <h1 class="font-bold text-white text-lg tracking-tight">${y(e)}</h1>
        </div>
  ...
  `),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`));let t=e.querySelector(`#searchBtn`);t.addEventListener(`click`,async()=>{let n=e.querySelector(`#searchId`).value.trim();if(n.length!==10||!/^\d+$/.test(n)){x(`Please enter a valid 10-digit numeric ID.`,`error`);return}b(t,!0,`🔍 Find Nomination`);try{let t=await u.getNomination(n);ae(e.querySelector(`#resultArea`),t,n)}catch(t){e.querySelector(`#resultArea`).innerHTML=`<div class="alert alert-error mt-4">❌ ${y(t.message)}</div>`}finally{b(t,!1,`🔍 Find Nomination`)}})}function ae(e,t,n){let r=t.dob||`N/A`,i=new Date(t.dob);isNaN(i.getTime())||(r=`${String(i.getDate()).padStart(2,`0`)}/${String(i.getMonth()+1).padStart(2,`0`)}/${i.getFullYear()}`);let a=d(t.dob);e.innerHTML=`
    <div class="space-y-4">
      <div class="alert alert-success">✅ Nomination found! Status: <strong>${y(t.status)}</strong></div>
    ...
    </div>`,e.querySelector(`#printBtn`).addEventListener(`click`,()=>{v(e.querySelector(`#printZone`).innerHTML)})}function oe(e,t){return`
  <div class="page-enter min-h-screen">
    <header class="no-print sticky top-0 z-10 border-b border-white/10 glass">
      <div class="max-w-4xl mx-auto px-6 py-3 flex items-center gap-4">
        ...
        <h1 class="font-bold text-white text-sm">${y(e)}</h1>
      </div>
    </header>
    <main class="max-w-4xl mx-auto px-4 py-8">${t}</main>
  </div>`}async function se(e){e.innerHTML=le(`Valid Nominations List`,`
  ...
  `),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`));try{let t=await u.getValidNominations();ce(e.querySelector(`main`),t)}catch(t){e.querySelector(`main`).innerHTML=`<div class="alert alert-warning text-center py-10 shadow-xl">${y(t.message)}</div>`}}function ce(e,t){if(!t||t.length===0){e.innerHTML=`
        ...
        ${Object.entries(n).map(([e,t])=>`
          <div class="glass rounded-2xl overflow-hidden shadow-2xl border border-white/5">
            <div class="px-6 py-4 bg-gradient-to-r from-indigo-500/10 to-purple-500/5 border-b border-white/10 flex justify-between items-center">
              <h3 class="font-bold text-indigo-300 text-sm uppercase tracking-widest">${y(e)}</h3>
                ...
                <tbody>
                  ${t.map((e,t)=>`
                    <tr class="hover:bg-white/[0.02] transition-colors">
                      ...
                      <td>
                        <div class="font-bold text-white text-base">${y(e.candidateName)}</div>
                        <div class="text-xs text-slate-500 mt-0.5">${y(e.candidateClass)}</div>
                      </td>
                      <td class="text-sm text-slate-400">${y(e.candidateDept)}</td>
                      <td class="text-right font-mono text-indigo-400/70 text-[10px]">${y(e.id)}</td>
                    </tr>
                  `).join(``)}
                </tbody>
              </table>
    ...
    <header class="no-print sticky top-0 z-10 border-b border-white/10 glass">
      <div class="max-w-5xl mx-auto px-6 py-3 flex items-center justify-between">
        <div class="flex items-center gap-4">
          <button id="backToHome" class="text-slate-400 hover:text-white transition text-sm">← Home</button>
          <span class="text-slate-600">|</span>
          <h1 class="font-bold text-white text-sm tracking-tight">${y(e)}</h1>
        </div>
  ...
  </div>`}async function ue(e){let t=new Date().getFullYear();try{let e=await u.getPublicSchedule();e.electionYear&&(t=e.electionYear)}catch{}e.innerHTML=fe(`Final Candidates List`,`
  ...
  `,t),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`));try{let n=await u.getFinalNominations();de(e.querySelector(`main`),n.active||[],t)}catch(t){e.querySelector(`main`).innerHTML=`<div class="alert alert-warning text-center py-10 shadow-xl">${y(t.message)}</div>`}}function de(e,t,n){if(!t||t.length===0){e.innerHTML=`
      <div class="glass rounded-3xl p-20 text-center border-dashed border-white/10">
        <div class="text-6xl mb-6">🏁</div>
    ...
    </div>`}function fe(e,t,n=`2026`){return`
  <div class="page-enter min-h-screen">
    <header class="no-print sticky top-0 z-10 border-b border-white/10 glass">
      <div class="max-w-5xl mx-auto px-6 py-3 flex items-center justify-between">
        <div class="flex items-center gap-4">
    ...
    <main class="max-w-5xl mx-auto px-4 py-12">${t}</main>
  </div>`}async function pe(e){e.innerHTML=ge(`Withdrawal Form`,`
    <div id="loadingState" class="flex flex-col items-center justify-center py-24 gap-4">
      <span class="spinner" style="width:2.5rem;height:2.5rem;border-width:4px;"></span>
      <p class="text-slate-400 text-sm">Checking schedule...</p>
    </div>
    <div id="withdrawArea" class="hidden"></div>
  `),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`));try{let t=await u.getPublicSchedule().catch(()=>({})),n=new Date,r=t.withdrawalStart?new Date(t.withdrawalStart):null,i=t.withdrawalEnd?new Date(t.withdrawalEnd):null,a=e.querySelector(`#withdrawArea`);if(e.querySelector(`#loadingState`).classList.add(`hidden`),a.classList.remove(`hidden`),r&&n<r){a.innerHTML=`
    ...
    `;let s=a.querySelector(`#fetchBtn`);s.addEventListener(`click`,async()=>{let e=a.querySelector(`#withdrawId`).value.trim();if(e.length!==10||!/^\d+$/.test(e)){x(`Please enter a valid 10-digit numeric ID.`,`error`);return}b(s,!0,`Fetch Nomination Details`);try{let t=await u.getNomination(e);me(a.querySelector(`#nominationDetails`),t,e)}catch(e){a.querySelector(`#nominationDetails`).innerHTML=`<div class="alert alert-error">❌ ${y(e.message)}</div>`}finally{b(s,!1,`Fetch Nomination Details`)}})}catch(t){e.querySelector(`#loadingState`).innerHTML=`<div class="alert alert-error">❌ ${y(t.message)}</div>`}}function me(e,t,n){if(t.status!==`Valid`){e.innerHTML=`<div class="alert alert-warning">⚠ This nomination has status <strong>${y(t.status)}</strong>. Only <strong>Valid</strong> nominations can be withdrawn.</div>`;return}if(t.withdrawalStatus===`Requested`||t.withdrawalStatus===`Approved`){e.innerHTML=`<div class="alert alert-info">ℹ A withdrawal has already been ${y(t.withdrawalStatus.toLowerCase())} for this nomination.</div>`;return}e.innerHTML=`
    <div class="space-y-4">
      ...
      <div class="glass rounded-xl p-5 text-sm space-y-2">
        <p><span class="text-slate-400 w-36 inline-block">Nomination ID:</span> <strong class="font-mono text-indigo-300">${y(n)}</strong></p>
        <p><span class="text-slate-400 w-36 inline-block">Post:</span> <strong class="text-white">${y(t.post)}</strong></p>
        <p><span class="text-slate-400 w-36 inline-block">Candidate:</span> ${y(t.candidate?.NAME||t.candidateName||`N/A`)}</p>
        <p><span class="text-slate-400 w-36 inline-block">Class:</span> ${y(t.candidate?.CLASS||t.candidateClass||`N/A`)}</p>
        <p><span class="text-slate-400 w-36 inline-block">Dept:</span> ${y(t.candidate?.Dept||t.candidateDept||`N/A`)}</p>
      </div>
      ...
      <div class="flex gap-3">
    ...
    </div>`,e.querySelector(`#withdrawBtn`).addEventListener(`click`,async()=>{let r=e.querySelector(`#withdrawBtn`);b(r,!0,`Submit Withdrawal Request`);try{await u.submitWithdrawal(n),e.innerHTML=`
        ...
        <div class="print-zone mt-4">
          ${he(n,t)}
        </div>`,e.querySelector(`#printWithdrawal`).addEventListener(`click`,v),x(`Withdrawal request submitted!`,`success`)}catch(e){x(`Failed: ${e.message}`,`error`),b(r,!1,`Submit Withdrawal Request`)}})}function he(e,t){let r=m(),i=t.candidate?.NAME||t.candidateName||`N/A`,a=t.candidate?.CLASS||t.candidateClass||`N/A`,o=t.candidate?.Dept||t.candidateDept||`N/A`;return`
  <div class="print-paper border border-slate-700 rounded-xl p-8 bg-slate-900 text-slate-200 space-y-5">
    <div class="flex justify-between text-sm">
      <div>
        <p class="font-bold text-white text-base">${y(n.COLLEGE_NAME)}</p>
    ...
    <div class="space-y-2 text-sm">
      <p><span class="text-slate-400 w-40 inline-block">Nomination ID:</span> <strong class="font-mono text-indigo-300 text-lg">${y(e)}</strong></p>
      <p><span class="text-slate-400 w-40 inline-block">Post:</span> <strong class="text-white">${y(t.post)}</strong></p>
      <p><span class="text-slate-400 w-40 inline-block">Candidate Name:</span> ${y(i)}</p>
      <p><span class="text-slate-400 w-40 inline-block">Class:</span> ${y(a)}</p>
      <p><span class="text-slate-400 w-40 inline-block">Department:</span> ${y(o)}</p>
    </div>
    <p class="text-sm text-slate-300 border border-white/10 rounded-lg p-4">
      I, <strong>${y(i)}</strong>, hereby withdraw my nomination for the post of <strong>${y(t.post)}</strong> in the College Union Election.
    </p>
  ...
  `;let t=e.querySelector(`#loginForm`),n=e.querySelector(`#errorMsg`),i=e.querySelector(`#passwordStep`),a=e.querySelector(`#otpStep`),o=e.querySelector(`#adminPassword`),s=e.querySelector(`#adminOTP`),c=e=>{n.textContent=e,n.classList.remove(`hidden`),n.classList.add(`shake`),setTimeout(()=>n.classList.remove(`shake`),500)};t.onsubmit=async t=>{t.preventDefault();let r=o.value.trim();if(!r)return c(`Please enter the admin password.`);let l=e.querySelector(`#btnRequestOTP`);b(l,!0,`Verifying...`),n.classList.add(`hidden`);try{await u.adminSendOTP(r),i.classList.add(`hidden`),a.classList.remove(`hidden`),a.classList.add(`page-enter`),s.focus(),x(`OTP sent successfully!`,`success`)}catch(e){c(e.message===`Unauthorized`?`Incorrect admin password.`:e.message)}finally{b(l,!1,`Request Secure OTP`)}},e.querySelector(`#btnVerifyLogin`).onclick=async e=>{let t=o.value.trim(),i=s.value.trim();if(!i||i.length!==6)return c(`Please enter a valid 6-digit OTP.`);b(e.target,!0,`Verifying OTP...`),n.classList.add(`hidden`);try{await u.adminVerifyOTP(t,i);let e=new Date().toISOString().split(`T`)[0];localStorage.setItem(`adminPwd`,t),localStorage.setItem(`adminLoginDate`,e),x(`Authentication successful!`,`success`),L(async()=>{let{router:e}=await Promise.resolve().then(()=>r);return{router:e}},void 0).then(({router:e})=>e.navigate(`/admin/dashboard`))}catch(e){c(e.message)}finally{b(e.target,!1,`Verify & Login`)}},e.querySelector(`#btnBackToPassword`).onclick=()=>{a.classList.add(`hidden`),i.classList.remove(`hidden`),i.classList.add(`page-enter`),n.classList.add(`hidden`)}}function R(){let e=localStorage.getItem(`adminPwd`),t=localStorage.getItem(`adminLoginDate`),n=new Date().toISOString().split(`T`)[0];return!e||t!==n?(e&&(localStorage.removeItem(`adminPwd`),localStorage.removeItem(`adminLoginDate`),x(`Daily session expired. Please log in again.`,`warning`)),o.navigate(`/admin`),null):e}function z(e,t,n){e.innerHTML=`
  <div class="min-h-screen flex">
    ...
    <aside class="no-print w-60 flex-shrink-0 glass border-r border-white/10 flex flex-col">
      ...
      <nav class="flex-1 p-3 space-y-1">
        ...
        ${B(`counting`,`🧮`,`Counting Setup`,t)}
        ${B(`results-entry`,`📥`,`Results Entry`,t)}
        ${B(`results`,`🏆`,`Election Results`,t)}
        <div class="border-t border-white/10 my-2"></div>
        ${B(`public`,`🌐`,`Public Portal`,t)}
        <div class="border-t border-white/10 my-2"></div>
        ${B(`testing`,`🧪`,`Testing Tools`,t)}
      </nav>
  ...
  </div>`,e.querySelectorAll(`[data-admin-nav]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.adminNav;if(t===`public`){o.navigate(`/`);return}o.navigate(`/admin/${t}`)})}),e.querySelector(`#logoutBtn`).addEventListener(`click`,()=>{localStorage.removeItem(`adminPwd`),localStorage.removeItem(`adminLoginDate`),x(`Logged out.`,`info`),o.navigate(`/`)})}function B(e,t,n,r){return`
  <button data-admin-nav="${e}" class="sidebar-item ${r===e?`active`:``}">
    <span>${t}</span> ${n}
  </button>`}async function ye(e){let t=R();if(t){z(e,`dashboard`,`
  ...
  `);try{let[n,i]=await Promise.all([u.adminGetNominations(t),u.adminGetSettings(t)]),a=n.length,o=n.filter(e=>e.status===`Pending`).length,s=n.filter(e=>e.status===`Valid`).length,c=n.filter(e=>e.status===`Rejected`).length,l=n.filter(e=>e.withdrawalStatus===`Requested`).length,d=e.querySelector(`#adminMain`);d.innerHTML=`
          ...
          <div class="glass rounded-2xl p-6 space-y-4">
            ...
            <div class="space-y-4">
              <div>
                ...
                <input type="text" id="inputCollegeName" class="field text-xs py-1.5" value="${y(i.collegeName)}">
              </div>
              <div>
                <label class="text-[10px] text-slate-500 uppercase tracking-wider block mb-1">Short Form (Abbreviation)</label>
                <input type="text" id="inputCollegeShort" class="field text-xs py-1.5" value="${y(i.collegeShortName)}">
              </div>
            ...
            <table class="data-table">
              ...
              <tbody>
                ${n.slice(-10).reverse().map(e=>`
                  <tr>
                    <td class="font-mono text-indigo-400 text-xs">${y(e.id)}</td>
                    <td>
                      <div class="font-semibold text-white">${y(e.candidateName)}</div>
                      <div class="text-[10px] text-slate-500">${y(e.candidateClass)}</div>
                    </td>
                    <td class="text-xs text-slate-300 font-medium">${y(e.post)}</td>
                    <td class="text-xs text-slate-400">${y(e.candidateDept)}</td>
                    <td><span class="badge badge-${(e.status||`pending`).toLowerCase()}">${y(e.status)}</span></td>
                  </tr>
                `).join(``)}
              </tbody>
            </table>
      ...
      </div>`,e.querySelectorAll(`[data-admin-nav]`).forEach(e=>{e.addEventListener(`click`,()=>{L(async()=>{let{router:e}=await Promise.resolve().then(()=>r);return{router:e}},void 0).then(({router:t})=>t.navigate(`/admin/${e.dataset.adminNav}`))})}),e.querySelector(`#btnUpdateBranding`).addEventListener(`click`,async()=>{let n=e.querySelector(`#inputCollegeName`).value.trim(),r=e.querySelector(`#inputCollegeShort`).value.trim();if(!n||!r)return x(`Please fill all branding fields.`,`error`);try{await u.adminUpdateSettings(t,{collegeName:n,collegeShortName:r}),x(`College branding updated successfully! Refresh to see changes system-wide.`,`success`)}catch(e){x(e.message,`error`)}})}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${y(t.message)}</div>`}}}function V(e,t,n,r){return`
  ...
  </div>`}async function be(e){let t=R();if(t){z(e,`verify`,`
  ...
  `);try{let n=await u.adminGetNominations(t);xe(e.querySelector(`#adminMain`),n,t)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${y(t.message)}</div>`}}}function xe(e,t,n){e.innerHTML=`
    <div class="page-enter space-y-4">
      ...
      <tr id="row-${y(e.id)}">
        <td class="font-mono text-indigo-300 text-xs">${y(e.id)}</td>
        <td class="text-xs max-w-[140px] leading-snug font-medium">${y(e.post)}</td>
        <td class="font-bold text-white">${y(e.candidateName||e.candidate?.NAME||`N/A`)}</td>
        <td class="text-xs text-slate-400">
          <div>${y(e.candidateClass||``)}</div>
          <div class="text-[10px] opacity-60">${y(e.candidateDept||``)}</div>
        </td>
        <td class="text-xs">${y(e.proposerName||e.proposer?.NAME||`N/A`)}</td>
        <td class="text-xs">${y(e.seconderName||e.seconder?.NAME||`N/A`)}</td>
        <td><span class="badge badge-${(e.status||`pending`).toLowerCase()}">${y(e.status)}</span></td>
        <td>
          <div class="flex gap-2">
            <button class="btn btn-primary btn-sm verify-btn bg-emerald-600/20 hover:bg-emerald-600 text-emerald-400 hover:text-white" data-id="${y(e.id)}" data-action="Valid"
              ${e.status===`Valid`?`disabled`:``}>Valid</button>
            <button class="btn btn-secondary btn-sm verify-btn bg-rose-600/20 hover:bg-rose-600 text-rose-400 hover:text-white" data-id="${y(e.id)}" data-action="Rejected"
              ${e.status===`Rejected`?`disabled`:``}>Reject</button>
          </div>
        </td>
      </tr>`).join(``):`<tr><td colspan="8" class="text-center text-slate-500 py-12">No nominations found matching those criteria.</td></tr>`},a=()=>{let t=e.querySelector(`#nomSearch`).value.toLowerCase(),n=e.querySelector(`#statusFilter`).value;i(r.filter(e=>{let r=n===`all`||e.status===n,i=!t||String(e.id).toLowerCase().includes(t)||String(e.candidateName||e.candidate?.NAME||``).toLowerCase().includes(t)||String(e.post).toLowerCase().includes(t);return r&&i}))};e.querySelector(`#nomSearch`).addEventListener(`input`,a),e.querySelector(`#statusFilter`).addEventListener(`change`,a),i(r),e.querySelector(`#nomTableBody`).addEventListener(`click`,async e=>{let t=e.target.closest(`.verify-btn`);if(!t)return;let i=t.dataset.id,o=t.dataset.action;t.disabled=!0;let s=t.textContent;t.innerHTML=`<span class="spinner" style="width:1rem;height:1rem;border-width:2px;"></span>`;try{await u.adminVerifyNomination(n,i,o);let e=r.find(e=>e.id===i);e&&(e.status=o),x(`Nomination ${i} marked as ${o}.`,`success`),a()}catch(e){x(`Failed: ${e.message}`,`error`),t.disabled=!1,t.textContent=s}})}async function Se(e){let t=R();if(t){z(e,`withdrawals`,`
  ...
  `);try{let n=(await u.adminGetNominations(t)).filter(e=>e.withdrawalStatus&&e.withdrawalStatus!==`None`);Ce(e.querySelector(`#adminMain`),n,t)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${y(t.message)}</div>`}}}function Ce(e,t,n){let r=Array.isArray(t)?t:[];e.innerHTML=`
    <div class="page-enter space-y-4">
      <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
      ...
      <tr id="wrow-${y(e.id)}">
        <td class="font-mono text-indigo-300 text-xs">${y(e.id)}</td>
        <td class="text-xs font-medium text-slate-300">${y(e.post)}</td>
        <td class="font-bold text-white">${y(e.candidateName||e.candidate?.NAME||`N/A`)}</td>
        <td class="text-xs text-slate-400">${y(e.candidateClass||``)} / ${y(e.candidateDept||``)}</td>
        <td>
          <span class="badge ${e.withdrawalStatus===`Approved`?`badge-valid`:`badge-pending`}">
            ${y(e.withdrawalStatus)}
          </span>
        </td>
        <td>
          <button class="btn btn-primary btn-sm approve-btn bg-emerald-600/20 hover:bg-emerald-600 text-emerald-400 hover:text-white" data-id="${y(e.id)}"
            ${e.withdrawalStatus===`Approved`?`disabled`:``}>
            ✅ Approve
          </button>
        </td>
      </tr>`).join(``):`<tr><td colspan="6" class="text-center text-slate-500 py-12">No withdrawal requests found matching those criteria.</td></tr>`},a=()=>{let t=e.querySelector(`#withSearch`).value.toLowerCase();i(r.filter(e=>!t||String(e.id).toLowerCase().includes(t)||String(e.candidateName||e.candidate?.NAME||``).toLowerCase().includes(t)||String(e.post).toLowerCase().includes(t)))};e.querySelector(`#withSearch`).addEventListener(`input`,a),i(r),e.addEventListener(`click`,async e=>{let t=e.target.closest(`.approve-btn`);if(!t)return;let i=t.dataset.id;t.disabled=!0;let o=t.innerHTML;t.innerHTML=`<span class="spinner" style="width:1rem;height:1rem;border-width:2px;"></span>`;try{await u.adminApproveWithdrawal(n,i),x(`Withdrawal for ${i} approved.`,`success`);let e=r.find(e=>e.id===i);e&&(e.withdrawalStatus=`Approved`),a()}catch(e){x(`Failed: ${e.message}`,`error`),t.disabled=!1,t.innerHTML=o}})}async function we(e){let t=R();if(t){z(e,`publish`,`
  ...
  `);try{let[n,r,i]=await Promise.all([u.adminGetSettings(t),u.adminGetNominations(t),u.getPosts()]);H(e.querySelector(`#adminMain`),n,r,i,t)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${y(t.message)}</div>`}}}function H(e,t,n,r,i){let a=t.validListPublished===`true`,o=t.finalListPublished===`true`;e.innerHTML=`
    ...
    `;o.forEach(e=>{s+=`
      ...
      `,a[e].forEach((e,t)=>{s+=`
          <tr>
            ...
            <td style="border:1px solid #000;padding:8px;font-weight:bold">${y(e.candidateName)}</td>
            <td style="border:1px solid #000;padding:8px">${y(e.candidateClass)}</td>
            <td style="border:1px solid #000;padding:8px">${y(e.candidateDept)}</td>
          </tr>
        `})}),s+=`
        </tbody>
      </table>
    ...
    </style></head><body>${s}<script>window.onload=()=>setTimeout(()=>window.print(),500)<\/script></body></html>`),c.document.close()};e.querySelector(`#btnPrintValid`).addEventListener(`click`,()=>s(`valid`)),e.querySelector(`#btnPrintFinal`).addEventListener(`click`,()=>s(`final`)),e.querySelector(`#publishValidBtn`)?.addEventListener(`click`,async t=>{let a=t.currentTarget;if(confirm(`Are you sure you want to publish the valid nominations list? This will be visible to all students.`)){b(a,!0,`📢 Publish Valid Nominations List`);try{await u.adminPublishValidList(i),x(`Valid nominations list published successfully!`,`success`),H(e,{validListPublished:`true`,finalListPublished:o?`true`:`false`},n,r,i)}catch(e){x(`Failed: ${e.message}`,`error`),b(a,!1,`📢 Publish Valid Nominations List`)}}}),e.querySelector(`#publishFinalBtn`)?.addEventListener(`click`,async t=>{let a=t.currentTarget;if(confirm(`Are you sure you want to publish the final nominations list?`)){b(a,!0,`📢 Publish Final Nominations List`);try{await u.adminPublishFinalList(i),x(`Final nominations list published successfully!`,`success`),H(e,{validListPublished:`true`,finalListPublished:`true`},n,r,i)}catch(e){x(`Failed: ${e.message}`,`error`),b(a,!1,`📢 Publish Final Nominations List`)}}})}async function Te(e){let t=R();if(t){z(e,`posts`,`
    <div class="text-center py-16">
      <span class="spinner" style="width:2.5rem;height:2.5rem;border-width:4px;"></span>
      <p class="text-slate-400 mt-4 text-sm">Loading posts...</p>
    </div>
  `);try{let r=await u.adminGetPosts(t).catch(()=>null);(!Array.isArray(r)||r.length===0)&&(r=n.DEFAULT_POSTS),Ee(e.querySelector(`#adminMain`),r,t)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${y(t.message)}</div>`}}}function Ee(e,t,n){e.innerHTML=`
    <div class="page-enter space-y-6">
    ...
    </div>`,U(e,t,n),De(e,t,n)}function U(e,t,n){let r=e.querySelector(`#postsBody`);r.innerHTML=t.length?t.map((e,t)=>`
    <tr id="post-row-${t}">
      <td class="text-slate-500 text-xs">${t+1}</td>
      <td class="font-medium text-white">${y(e.post)}</td>
        ...
        <div class="facing-sheet">
          ...
          <div style="font-size: 16px; margin-bottom: 15px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px dashed #ccc; padding-bottom: 10px;">
            <div>
              ...
              <span style="margin-left: 20px;"><strong>LOC:</strong> ${y(e.roomName||`UNSPECIFIED`)}</span>
            </div>
        ...
        <div class="page-break">
          <div class="roll-page">
            <div class="roll-header">
              <div><strong>BOOTH ${e.boothNumber}</strong> | ${y(e.roomName||`No Room`)}</div>
  ...
  `);try{let[n,r,i,a,o]=await Promise.all([u.adminGetCountingMatrix(t).catch(()=>null),u.getPosts(),u.adminGetNominations(t).catch(()=>[]),u.adminGetBooths(t),u.getNominalRoll()]),s=(Array.isArray(i)?i:[]).filter(e=>e.status===`Valid`&&e.withdrawalStatus!==`Approved`);je(e.querySelector(`#adminMain`),t,n,r,s,a,o)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${y(t.message)}</div>`}}}function je(e,t,n,r,i,a,o){if(!a.length){e.innerHTML=`<div class="alert alert-error">❌ No booths configured.</div>`;return}if(!r.length){e.innerHTML=`<div class="alert alert-error">❌ No posts configured.</div>`;return}let s=e=>String(e.post||e.name||``),c=t=>{let{matrix:n,formSerials:o,totalRounds:c,roundLabels:u}=t,d=a.length;e.innerHTML=`
                ...
                ${a.map((e,t)=>`
                  <tr>
                    <td class="font-bold text-indigo-300 whitespace-nowrap">
                      ...
                      <span class="text-xs text-slate-500 font-normal">${y(e.roomName||``)}</span>
                    </td>
                    ${n[t].map((e,n)=>`
                      <td class="align-top py-2 min-w-[100px]">
                        ${e?`<div class="text-[10px] text-slate-500 mb-0.5 font-mono">#${o[`${t}-${n}`]}</div>
                             <div class="badge badge-valid block text-left" title="${y(s(e))}">${y(s(e))}</div>`:`<span class="text-slate-600">–</span>`}
                      </td>`).join(``)}
                  </tr>`).join(``)}
              </tbody>
            </table>
      ...
      </style></head><body>${e}<script>window.onload=()=>setTimeout(()=>window.print(),400)<\/script></body></html>`),r.document.close()})},l=async()=>{let n=a.length,i=e=>{let t=s(e);return t.toUpperCase().startsWith(`ASSOCIATION SECRETARY `)?t.substring(22).toUpperCase().trim():null},l={};o.forEach(e=>{let t=String(e.CLASS||``).trim(),n=String(e.Dept||``).trim().toUpperCase();t&&n&&(l[t]=n)});let d=a.map(e=>new Set((e.classes||[]).map(e=>l[e]||``).filter(Boolean))),f=a.map(e=>{let t=new Set;return(e.classes||[]).forEach(e=>{let n=e.toUpperCase();[`MA`,`MSC`,`MCOM`,`M.SC`,`M.COM`,`M.A`].some(e=>n.includes(e))?t.add(`PG`):(n.includes(`1ST YEAR`)&&t.add(`1`),n.includes(`2ND YEAR`)&&t.add(`2`),n.includes(`3RD YEAR`)&&t.add(`3`))}),t}),p=r.filter(e=>{let t=s(e).toUpperCase();return t.includes(`UUC`)||t.includes(`UNIVERSITY UNION COUNCILLOR`)}),m=r.filter(e=>!p.includes(e)&&s(e).toUpperCase().includes(`ASSOCIATION`)),h=r.filter(e=>!p.includes(e)&&!m.includes(e)&&e.yearRestriction&&String(e.yearRestriction).trim()!==``),g=r.filter(e=>!p.includes(e)&&!m.includes(e)&&!h.includes(e)),_=g.length,v=Array.from({length:n},(e,t)=>{let n=[];m.forEach(e=>{let r=i(e);r&&d[t].has(r)&&n.push(e)}),h.forEach(e=>{f[t].has(String(e.yearRestriction))&&n.push(e)});for(let e=0;e<_;e++)n.push(g[(t+e)%_]);return p.forEach(e=>n.push(e)),n}),y=Math.max(...v.map(e=>e.length),0);v.forEach(e=>{for(;e.length<y;)e.push(null)});let b={},S=1;for(let e=0;e<y;e++)for(let t=0;t<n;t++)v[t][e]&&(b[`${t}-${e}`]=S++);let C=[];for(let e=0;e<y;e++)C.push(`Round ${e+1}`);let w={matrix:v,formSerials:b,totalRounds:y,roundLabels:C};try{e.innerHTML=`<div class="text-center py-20"><span class="spinner"></span><p class="mt-4 text-slate-400">Saving Matrix...</p></div>`,await u.adminSaveCountingMatrix(t,w),x(`Counting Matrix saved successfully!`,`success`),c(w)}catch(e){x(`Error saving matrix: `+e.message,`error`),c(w)}};n?c(n):(e.innerHTML=`
    ...
    `,e.querySelector(`#btnInitialGenerate`).addEventListener(`click`,l))}function Me(e,t,n,r,i){let a=r.length?r.map((e,t)=>`<tr>
        ...
        <td style="padding:18px 8px;font-size:15px;font-weight:bold">
          ${y(e.candidateName||``)}
          <div style="font-size:11px;font-weight:normal;color:#333;margin-top:2px;">${y(e.candidateClass||``)}</div>
        </td>
    ...
    <div style="text-align:center;border-bottom:2px solid #000;padding-bottom:10px;margin-bottom:16px;padding-right:100px;">
      ...
      <h3 style="margin:10px 0 0;font-size:15px;text-decoration:underline;text-transform:uppercase">POST: ${y(n)}</h3>
    </div>
    <table>
      <thead><tr>
  ...
  </div>`}async function Ne(e){let t=R();if(t){z(e,`results-entry`,`
    <div class="text-center py-16"><span class="spinner" style="width:2.5rem;height:2.5rem;border-width:4px;"></span><p class="text-slate-400 mt-4 text-sm">Loading data...</p></div>
  `);try{let[n,r,i,a,o]=await Promise.all([u.adminGetBooths(t).catch(()=>[]),u.getPosts(),u.adminGetNominations(t).catch(()=>[]),u.getResults().catch(()=>[]),u.adminGetCountingMatrix(t).catch(()=>null)]),s=(Array.isArray(i)?i:[]).filter(e=>e.status===`Valid`&&e.withdrawalStatus!==`Approved`);Pe(e.querySelector(`#adminMain`),t,n,r,s,a,o)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${y(t.message)}</div>`}}}function Pe(e,t,n,r,i,a,o){let s=e=>String(e.post||e.name||``);if(!o){e.innerHTML=`
    ...
    `;return}let{matrix:c,formSerials:l}=o,d={};Object.entries(l).forEach(([e,t])=>{let[n,r]=e.split(`-`).map(Number),i=c[n][r];d[t]={t:n,r,postName:s(i)}}),e.innerHTML=`
        ...
        <div class="glass rounded-xl p-6 opacity-60">
          ...
          <div class="flex gap-2">
            ...
            <select id="selPost" class="field text-xs">
              ...
              ${r.map(e=>`<option value="${y(e.post||e.name)}">${y(e.post||e.name)}</option>`).join(``)}
            </select>
  ...
  `;let f=e.querySelector(`#txtSerial`),p=e.querySelector(`#btnLoadBySerial`),m=async()=>{let e=f.value.trim();if(!e)return;let t=d[e];if(!t){x(`Invalid Serial Number: ${e}`,`error`);return}try{b(p,!0,`Loading...`);let r=await u.getResults().catch(()=>[]);a.length=0,a.push(...r),h(n[t.t].boothNumber,t.postName,e,t.r+1)}catch{h(n[t.t].boothNumber,t.postName,e,t.r+1)}finally{b(p,!1,`Load Form`)}};p.addEventListener(`click`,m),f.addEventListener(`keypress`,e=>{e.key===`Enter`&&m()}),e.querySelector(`#btnLoadForm`).addEventListener(`click`,async()=>{let t=e.querySelector(`#selTable`).value,r=e.querySelector(`#selPost`).value;if(!t||!r){x(`Select Table and Post`,`warning`);return}let i=n.findIndex(e=>String(e.boothNumber)===String(t)),o=null,d=null;if(i>=0){for(let e=0;e<c[i].length;e++)if(s(c[i][e])===r){d=e+1,o=l[`${i}-${e}`];break}}try{b(e.querySelector(`#btnLoadForm`),!0,`...`);let n=await u.getResults().catch(()=>[]);a.length=0,a.push(...n),h(t,r,o,d)}catch{h(t,r,o,d)}finally{b(e.querySelector(`#btnLoadForm`),!1,`Load`)}});let h=(n,r,o,s)=>{let c=e.querySelector(`#entryFormArea`),l=i.filter(e=>e.post===r);if(l.length===0){c.innerHTML=`<div class="alert alert-warning">No candidates found for ${y(r)}.</div>`;return}let d=a.filter(e=>String(e.TableNumber)===String(n)&&String(e.Post)===r),p=e=>d.find(t=>t.CandidateId===e)?.Votes||``;c.innerHTML=`
      <div class="glass rounded-xl overflow-hidden page-enter">
        <div class="bg-indigo-500/10 p-4 border-b border-indigo-500/20 flex justify-between items-center">
          <div>
            <h4 class="font-bold text-indigo-300">Table ${n} • Round ${s||`N/A`} • ${y(r)}</h4>
          ...
          ${l.map((e,t)=>`
            <div class="flex items-center justify-between bg-white/5 p-4 rounded-lg border border-white/5">
              <div class="flex items-center gap-4">
                ...
                <div>
                  <div class="font-bold text-white">${y(e.candidateName)}</div>
                  <div class="text-xs text-slate-400">${y(e.candidateClass)}</div>
                </div>
              </div>
              <div class="w-32">
                <input type="number" class="field text-center text-lg font-bold vote-input" data-cid="${y(e.id)}" data-cname="${y(e.candidateName)}" placeholder="0" value="${p(e.id)}" min="0">
              </div>
            </div>
          `).join(``)}
    ...
    `;let m=()=>{let e=0;c.querySelectorAll(`.vote-input`).forEach(t=>{e+=parseInt(t.value,10)||0});let t=c.querySelector(`#totalVotesDisplay`);t&&(t.textContent=e)};c.querySelectorAll(`.vote-input`).forEach(e=>{e.addEventListener(`input`,m)}),m(),c.querySelector(`#btnSaveVotes`).addEventListener(`click`,async e=>{let i=e.target,l=c.querySelectorAll(`.vote-input`),d=[];if(l.forEach(e=>{let t=e.value.trim();t!==``&&d.push({TableNumber:n,RoundNumber:s,Post:r,CandidateId:e.dataset.cid,CandidateName:e.dataset.cname,Votes:parseInt(t,10),FormSerial:o||`N/A`})}),d.length===0){x(`Enter votes`,`warning`);return}b(i,!0,`💾 Saving...`);try{await u.adminSaveResults(t,d),d.forEach(e=>{let t=a.findIndex(t=>String(t.TableNumber)===String(n)&&String(t.Post)===r&&t.CandidateId===e.CandidateId);t>=0?(a[t].Votes=e.Votes,a[t].RoundNumber=e.RoundNumber,a[t].FormSerial=e.FormSerial):a.push(e)}),x(`Form results saved!`,`success`),c.innerHTML=``,f.value=``,f.focus()}catch(e){x(`Failed: ${e.message}`,`error`)}finally{b(i,!1,`💾 Save Form Results`)}})}}async function Fe(e){let t=R();if(!t)return;z(e,`Ballot Printing`,`
    <div class="text-center py-16">
      <span class="spinner" style="width:2.5rem;height:2.5rem;border-width:4px;"></span>
  ...
  `;let r=e=>{let t=window.open(``,`_blank`);t.document.write(`
    ...
    `),t.document.close()},i=async(e=`all`)=>{let n,r,i,a;try{[n,r,i,a]=await Promise.all([u.adminGetPosts(t),u.getFinalNominations(),u.getPublicSchedule(),u.adminGetSettings(t).catch(()=>({}))])}catch(e){throw Error(e.message.includes(`not published`)?`Final List Not Published. Please finalize and publish the list first.`:e.message)}let o=a.collegeName||`GOVERNMENT VICTORIA COLLEGE PALAKKAD`,s=a.collegeShortName||`GVC`,c=i.electionYear||new Date().getFullYear().toString(),l=r.active||[];if(l.length===0)throw Error(`No active candidates found.`);let d=e=>{let t=e.post.toLowerCase();return t.includes(`representative`)||t.includes(`year`)},f=e=>{let t=e.post.toLowerCase();return t.includes(`association`)||t.includes(`assoc`)},p=e=>!d(e)&&!f(e),m=n.filter(e=>l.filter(t=>t.post===e.post).length>1),h=``;if(e===`all`||e===`general`){let e=m.filter(p);if(e.length>0){h+=`
            ...
            <div class="post-box">
              ...
              ${i.map((e,t)=>`
                <div class="candidate-row">
                  ...
                  <div class="c-name">
                    <div style="font-size: 13px; text-transform: uppercase;">${y(e.candidateName)}</div>
                    <div style="font-size: 10px; font-weight: normal; color: #444;">${y(e.candidateClass)}</div>
                  </div>
        ...
        `}),h},a=async e=>{try{x(`Generating ballots...`,`info`),r(await i(e))}catch(e){x(e.message,`error`)}},o=async()=>{try{x(`Calculating ranges...`,`info`);let[e,n,i,a,o,s]=await Promise.all([u.adminGetBooths(t),u.getNominalRoll(),u.adminGetPosts(t),u.getFinalNominations(),u.getPublicSchedule(),u.adminGetSettings(t).catch(()=>({}))]),c=a.active||[],l=o.electionYear||new Date().getFullYear(),d=s.collegeName||`Government Victoria College Palakkad`;s.collegeShortName;let f=e=>e.post.toLowerCase().includes(`representative`)||e.post.toLowerCase().includes(`year`),p=e=>e.post.toLowerCase().includes(`association`)||e.post.toLowerCase().includes(`assoc`),m=1,h=1,g=1,_=[...e].sort((e,t)=>e.boothNumber-t.boothNumber),v=[],b=[],S=[];_.forEach(e=>{let t=n.filter(t=>e.classes.includes(String(t.CLASS).trim()));t.length!==0&&(v.push({booth:e.boothNumber,count:t.length,start:m,end:m+t.length-1}),m+=t.length)}),i.filter(f).filter(e=>c.filter(t=>t.post===e.post).length>1).forEach(e=>{let t=String(e.yearRestriction||``).trim().toUpperCase();if(!t)return;let r=[];_.forEach(i=>{let a=n.filter(e=>i.classes.includes(String(e.CLASS).trim())).filter(e=>{let n=String(e.CLASS||``).toUpperCase();return n.includes(`PH D`)||n.includes(`PH.D`)?!1:t===`PG`?/\b(MA|MSC|MCOM|M\.SC|M\.COM|M\.A)\b/i.test(n):t===`1`?/\b(I|1ST)\b\s*YEAR/i.test(n)&&!/\b(II|III)\b/i.test(n):t===`2`?/\b(II|2ND)\b\s*YEAR/i.test(n)&&!/\b(III)\b/i.test(n):t===`3`?/\b(III|3RD)\b\s*YEAR/i.test(n):n.includes(t)});a.length>0&&(r.push({booth:i.boothNumber,post:e.post,count:a.length,start:h,end:h+a.length-1}),h+=a.length)}),r.length>0&&b.push(...r)}),i.filter(p).filter(e=>c.filter(t=>t.post===e.post).length>1).forEach(e=>{let t=e.post.replace(`Association Secretary `,``).trim().toUpperCase(),r=[];_.forEach(i=>{let a=n.filter(e=>i.classes.includes(String(e.CLASS).trim())).filter(e=>{let n=String(e.Dept||``).trim().toUpperCase(),r=String(e.CLASS||``).trim().toUpperCase();return n.includes(t)||r.includes(t)});a.length>0&&(r.push({booth:i.boothNumber,post:e.post,count:a.length,start:g,end:g+a.length-1}),g+=a.length)}),r.length>0&&S.push(...r)}),r(`
        <div style="padding: 40px; font-family: sans-serif; color: #333;">
          <div style="text-align: center; border-bottom: 2px solid #000; padding-bottom: 20px; margin-bottom: 30px;">
            <h1 style="margin: 0; font-size: 24px;">BALLOT PRINTING SUMMARY - ${l}</h1>
            <h2 style="margin: 5px 0 0 0; font-size: 18px; color: #666;">${y(d)}</h2>
          </div>
          ...
          <table style="width: 100%; border-collapse: collapse; margin-bottom: 30px;">
            ...
            <tbody>
              ...
              <tr style="background: #f1f5f9; font-weight: bold;">
                ...
                <td style="border: 1px solid #ddd; padding: 10px; text-align: center;">${Math.ceil((m-1)/50)}</td>
              </tr>
            </tbody>
          </table>
          ...
          <table style="width: 100%; border-collapse: collapse; margin-bottom: 30px;">
            ...
            <tbody>
              ...
              <tr style="background: #f1f5f9; font-weight: bold;">
                ...
                <td style="border: 1px solid #ddd; padding: 10px; text-align: center;">R${h-1}</td>
              </tr>
            </tbody>
          </table>
          ...
          <table style="width: 100%; border-collapse: collapse; margin-bottom: 30px;">
            ...
            <tbody>
              ...
              <tr style="background: #f1f5f9; font-weight: bold;">
                ...
                <td style="border: 1px solid #ddd; padding: 10px; text-align: center;">${g-1}</td>
                <td style="border: 1px solid #ddd; padding: 10px; text-align: center;">A1</td>
                <td style="border: 1px solid #ddd; padding: 10px; text-align: center;">A${g-1}</td>
              </tr>
            </tbody>
          </table>
      ...
      `)}catch(e){x(e.message,`error`)}};n.querySelector(`#btnGenSummary`).onclick=o,n.querySelectorAll(`.preview-btn`).forEach(e=>{e.onclick=()=>a(e.dataset.type)})}function Ie(e){let t=R();if(!t)return;z(e,`testing`,`
...
Proceed?`))return;b(r,!0,`🧪 Inject Test Nominations`);let i=n.querySelector(`#injectStatus`);i.innerHTML=``;try{let e=await u.adminInjectTestData(t),n=e.skipped>0?`<br><span class="text-amber-400 text-xs mt-1 block">⚠️ ${e.skipped} post(s) skipped — not enough eligible students in NominalRoll: <em>${e.skippedPosts.join(`, `)}</em></span>`:``;i.innerHTML=`
        ...
        </div>`,x(`Injected ${e.injected} test nominations!`,`success`)}catch(e){i.innerHTML=`<div class="alert alert-error mt-3">❌ ${y(e.message)}</div>`,x(`Failed: ${e.message}`,`error`)}finally{b(r,!1,`🧪 Inject Test Nominations`)}}),n.querySelector(`#btnWipeData`).addEventListener(`click`,async e=>{let t=e.target,r=n.querySelector(`#wipePasswordInput`).value.trim();if(!r){x(`Please enter the admin password to confirm the wipe.`,`warning`),n.querySelector(`#wipePasswordInput`).focus();return}if(!confirm(`⚠️ DANGER ZONE ⚠️
...
Are you absolutely sure?`))return;b(t,!0,`🗑️ Wiping...`);let i=n.querySelector(`#wipeStatus`);i.innerHTML=``;try{await u.adminWipeData(r),n.querySelector(`#wipePasswordInput`).value=``,i.innerHTML=`
        ...
        </div>`,x(`All data wiped successfully.`,`success`)}catch(e){i.innerHTML=`<div class="alert alert-error mt-3">❌ ${y(e.message)}</div>`,x(`Failed: ${e.message}`,`error`)}finally{b(t,!1,`🗑️ Permanently Wipe All Data`)}})}async function Le(e){let t=R();if(t){z(e,`results`,`
  ...
  `,e.querySelector(`#btnPrintOfficial`).addEventListener(`click`,()=>{let e=`
    ...
    `),t.document.close()})}var W=`election_results_cache`,G=`election_results_last_fetch`,K=300*1e3;async function ze(e){e.innerHTML=`
    <div class="page-enter min-h-screen">
      <header class="no-print sticky top-0 z-10 border-b border-white/10 glass">
        <div class="max-w-5xl mx-auto px-6 py-3 flex items-center justify-between">
          <div class="flex items-center gap-4">
  ...
  `;let t=e.querySelector(`#cacheTimer`),n=()=>{let e=localStorage.getItem(G);if(!e){t.textContent=``;return}let n=parseInt(e,10)+K,r=Math.max(0,n-Date.now());r<=0?(t.textContent=`Live Update Available`,t.classList.add(`text-green-400`)):(t.textContent=`Update in ${Math.floor(r/6e4)}:${Math.floor(r%6e4/1e3).toString().padStart(2,`0`)}`,t.classList.remove(`text-green-400`))};setInterval(n,1e3),n(),e.querySelector(`#backToHome`).addEventListener(`click`,()=>o.navigate(`/`)),e.querySelector(`#btnRefresh`).addEventListener(`click`,()=>q(e.querySelector(`#resultsMain`),!0)),await q(e.querySelector(`#resultsMain`))}async function q(e,t=!1){try{let n=localStorage.getItem(G),r=localStorage.getItem(W),i,a;if(!t&&n&&r&&Date.now()-parseInt(n,10)<K){let t=JSON.parse(r);i=t.posts,a=t.results,o(e,(t.schedule||{}).electionYear||new Date().getFullYear())}else{let t;[i,a,t]=await Promise.all([u.getPosts(),u.getResults().catch(()=>[]),u.getPublicSchedule().catch(()=>({}))]),localStorage.setItem(G,Date.now().toString()),localStorage.setItem(W,JSON.stringify({posts:i,results:a,schedule:t})),o(e,t.electionYear||new Date().getFullYear())}function o(e,t){let n=e.closest(`.page-enter`)?.querySelector(`h1`);n&&(n.textContent=`Live Election Results ${t}`)}if(a.length===0){e.innerHTML=`
        <div class="text-center py-20 bg-white/5 rounded-2xl border border-white/10">
          <div class="text-5xl mb-4">📊</div>
      ...
      `:e.innerHTML=c}catch(t){e.innerHTML=`<div class="alert alert-error">❌ Failed to load results: ${y(t.message)}</div>`}}async function Be(e){e.innerHTML=`
  ...
  `;try{let[t,n]=await Promise.all([u.getNominalRoll(),u.getSettings()]);Ve(e,t,n)}catch(t){e.innerHTML=`<div class="alert alert-error">❌ ${y(t.message)}</div>`}}function Ve(e,t,n){let r=n.nominalRollFinalized===`true`,i=[...t],a=``,o=()=>{let t=i.filter(e=>[e.NAME,e.CLASS,e[`ADMISION NO`],e[`Nominal Roll Serial Number`]].some(e=>String(e||``).toLowerCase().includes(a.toLowerCase())));e.innerHTML=`
      <div class="page-enter space-y-6">
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
        ...
        <div class="glass rounded-xl p-4 flex flex-col md:flex-row gap-4 items-center">
          <div class="relative flex-1">
            <span class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500">🔍</span>
            <input type="text" id="searchInput" class="field pl-10" placeholder="Search by name, class, adm. no, or serial..." value="${y(a)}">
          </div>
          ...
          <div class="overflow-x-auto">
            <table class="data-table">
              ...
              <tbody>
                ${t.length?t.map(e=>`
                  <tr>
                    <td class="font-bold text-indigo-400">${y(e[`Nominal Roll Serial Number`])}</td>
                    <td class="font-mono text-xs">${y(e[`ADMISION NO`]||e[`ADMISSION NO`]||`–`)}</td>
                    <td class="text-white font-medium">${y(e.NAME)}</td>
                    <td class="text-slate-300 text-sm">${y(e.CLASS)}</td>
                  </tr>
    ...
    `;let n=e.querySelector(`.dropdown-toggle`),s=e.querySelector(`.dropdown-menu`);n&&(n.onclick=e=>{e.stopPropagation(),s.classList.toggle(`hidden`)}),window.onclick=()=>s?.classList.add(`hidden`),e.querySelector(`#searchInput`).oninput=t=>{a=t.target.value,o();let n=e.querySelector(`#searchInput`);n.focus();let r=n.value;n.value=``,n.value=r},e.querySelector(`#btnPrintSerial`).onclick=()=>J(i,r,`serial`),e.querySelector(`#btnPrintClass`).onclick=()=>J(i,r,`class`)};o()}function J(e,t,r){let i=[...e];r===`class`?i.sort((e,t)=>{let n=String(e.CLASS).toUpperCase(),r=String(t.CLASS).toUpperCase();return n===r?String(e.NAME).toUpperCase().localeCompare(String(t.NAME).toUpperCase()):n.localeCompare(r)}):i.sort((e,t)=>Number(e[`Nominal Roll Serial Number`])-Number(t[`Nominal Roll Serial Number`]));let a=n.COLLEGE_NAME||`GOVERNMENT VICTORIA COLLEGE, PALAKKAD`,o=t?`FINAL NOMINAL ROLL`:`DRAFT NOMINAL ROLL`,s=new Date().toLocaleString(),c=window.open(``,`_blank`);c.document.write(`
    <html>
      <head>
        <title>${o}</title>
        <style>
      ...
      <body>
        ...
        <table>
          ...
          <tbody>
            ${i.map(e=>`
              <tr>
                <td class="sl">${y(e[`Nominal Roll Serial Number`])}</td>
                <td class="adm">${y(e[`ADMISION NO`]||e[`ADMISSION NO`]||`–`)}</td>
                <td style="font-weight:bold">${y(e.NAME)}</td>
                <td class="cls">${y(e.CLASS)}</td>
              </tr>
            `).join(``)}
          </tbody>
        </table>
  ...
  `),c.document.close()}async function Y(e){let t=R();if(t){z(e,`nominalRoll`,`
    <div class="text-center py-16"><span class="spinner" style="width:2.5rem;height:2.5rem;border-width:4px;"></span><p class="text-slate-400 mt-4 text-sm">Loading nominal roll...</p></div>
  `);try{let[n,r]=await Promise.all([u.getNominalRoll(),u.getSettings()]);He(e.querySelector(`#adminMain`),t,n,r)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${y(t.message)}</div>`}}}function He(e,t,n,r){let i=r.nominalRollFinalized===`true`,a=[...n],o=``,s=[...new Set(n.map(e=>String(e.CLASS).trim()))].sort(),c=[...new Set(n.map(e=>String(e.Dept||`–`).trim()))].sort(),l=()=>{let n=a.filter(e=>[e.NAME,e.CLASS,e[`ADMISION NO`],e[`Nominal Roll Serial Number`]].some(e=>String(e||``).toLowerCase().includes(o.toLowerCase())));e.innerHTML=`
      <div class="page-enter space-y-6">
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
        ...
        <div class="glass rounded-xl p-4 flex flex-col md:flex-row gap-4 items-center">
          <div class="relative flex-1">
            <span class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500">🔍</span>
            <input type="text" id="searchInput" class="field pl-10" placeholder="Search by name, class, adm. no, or serial..." value="${y(o)}">
          </div>
              ...
              <tbody>
                ${n.length?n.map(e=>`
                  <tr>
                    ...
                    <td class="text-white font-medium">${y(e.NAME)}</td>
                    <td class="text-slate-300 text-sm">${y(e.CLASS)}</td>
                    <td class="text-slate-400 text-xs">${y(e.Dept||`–`)}</td>
                    ${i?``:`
                      <td>
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <select id="addClass" class="field">
                ...
                ${s.map(e=>`<option value="${y(e)}">${y(e)}</option>`).join(``)}
              </select>
            </div>
            <div>
            ...
            <div>
              ...
              <select id="addDept" class="field">
                ...
                ${c.map(e=>`<option value="${y(e)}">${y(e)}</option>`).join(``)}
              </select>
            </div>
          </div>
    ...
    `;let r=e.querySelector(`.dropdown-toggle`),d=e.querySelector(`.dropdown-menu`);r&&(r.onclick=e=>{e.stopPropagation(),d.classList.toggle(`hidden`)}),window.onclick=()=>d?.classList.add(`hidden`),e.querySelector(`#searchInput`).oninput=t=>{o=t.target.value,l(),e.querySelector(`#searchInput`).focus();let n=e.querySelector(`#searchInput`).value;e.querySelector(`#searchInput`).value=``,e.querySelector(`#searchInput`).value=n},i||(e.querySelector(`#btnAddNew`).onclick=()=>e.querySelector(`#addModal`).classList.remove(`hidden`),e.querySelector(`#btnCancelAdd`).onclick=()=>e.querySelector(`#addModal`).classList.add(`hidden`),e.querySelector(`#btnConfirmAdd`).onclick=async n=>{let r={serial:e.querySelector(`#addSerial`).value,name:e.querySelector(`#addName`).value,class:e.querySelector(`#addClass`).value,admission:e.querySelector(`#addAdm`).value,dept:e.querySelector(`#addDept`).value};if(!r.serial||!r.name||!r.class)return x(`Please fill required fields.`,`warning`);b(n.target,!0,`Save Student`);try{await u.adminAddStudent(t,r),x(`Student added to roll.`,`success`),Y(e.closest(`#appContainer`)||e.parentElement)}catch(e){x(e.message,`error`),b(n.target,!1,`Save Student`)}},e.querySelectorAll(`.delete-student`).forEach(n=>{n.onclick=async()=>{if(confirm(`Delete student #${n.dataset.serial}?`))try{await u.adminDeleteStudent(t,n.dataset.serial),x(`Student removed.`,`success`),Y(e.closest(`#appContainer`)||e.parentElement)}catch(e){x(e.message,`error`)}}}),e.querySelector(`#btnFinalize`).onclick=async n=>{if(confirm(`FINALIZATION WARNING:
...
Are you absolutely sure?`)){b(n.target,!0,`Finalizing...`);try{await u.adminFinalizeRoll(t),x(`Nominal Roll Finalized Successfully!`,`success`),Y(e.closest(`#appContainer`)||e.parentElement)}catch(e){x(e.message,`error`),b(n.target,!1,`Finalize & Lock Roll`)}}}),e.querySelector(`#btnPrintSerial`).onclick=()=>X(a,i,`serial`),e.querySelector(`#btnPrintClass`).onclick=()=>X(a,i,`class`)};l()}function X(e,t,r){let i=[...e];r===`class`?i.sort((e,t)=>{let n=String(e.CLASS).toUpperCase(),r=String(t.CLASS).toUpperCase();return n===r?String(e.NAME).toUpperCase().localeCompare(String(t.NAME).toUpperCase()):n.localeCompare(r)}):i.sort((e,t)=>Number(e[`Nominal Roll Serial Number`])-Number(t[`Nominal Roll Serial Number`]));let a=n.COLLEGE_NAME||`GOVERNMENT VICTORIA COLLEGE, PALAKKAD`,o=t?`FINAL NOMINAL ROLL`:`DRAFT NOMINAL ROLL`,s=new Date().toLocaleString(),c=window.open(``,`_blank`);c.document.write(`
    <html>
      <head>
        <title>${o}</title>
        <style>
  ...
  `),c.document.close()}async function Ue(e){let t=R();if(t){z(e,`schedule`,`
  ...
  `);try{let n=await u.getPublicSchedule();We(e.querySelector(`#adminMain`),t,n)}catch(t){e.querySelector(`#adminMain`).innerHTML=`<div class="alert alert-error">❌ ${y(t.message)}</div>`}}}function We(e,t,n){let r=e=>e?new Date(e).toISOString().slice(0,16):``;e.innerHTML=`
...
`),n.APPS_SCRIPT_URL.includes(`YOUR_SCRIPT_ID`)&&(document.body.insertAdjacentHTML(`afterbegin`,`
  ...
  `),document.getElementById(`app`).style.marginTop=`48px`);var $=e=>t=>{Q.innerHTML=``,e(Q,t)};o.on(`/`,$(S)).on(`/submit`,$(k)).on(`/find`,$(ie)).on(`/valid-list`,$(se)).on(`/final-list`,$(ue)).on(`/withdraw`,$(pe)).on(`/results`,$(ze)).on(`/nominal-roll`,$(Be)).on(`/admin`,$(ve)).on(`/admin/dashboard`,$(ye)).on(`/admin/verify`,$(be)).on(`/admin/withdrawals`,$(Se)).on(`/admin/publish`,$(we)).on(`/admin/posts`,$(Te)).on(`/admin/ballots`,$(Fe)).on(`/admin/booths`,$(Oe)).on(`/admin/counting`,$(Ae)).on(`/admin/results-entry`,$(Ne)).on(`/admin/results`,$(Le)).on(`/admin/nominal-roll`,$(Y)).on(`/admin/schedule`,$(Ue)).on(`/admin/direct-nomination`,$(Z)).on(`/admin/testing`,$(Ie)).setDefault(`/`),document.addEventListener(`click`,e=>{let t=e.target.closest(`[data-nav]`);t&&(e.preventDefault(),o.navigate(t.dataset.nav))}),o.start();